 ...
 * Slug: tropical-island/post-categories
...
<h2><?php esc_html_e( 'Post Categories ', 'tropical-island' )?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/internal.jpg" alt="" class="wp-image-2262"/></a></figure>
<!-- /wp:image -->
...
<h3 class="has-link-color"><a href="#"><?php esc_html_e( 'Sailing', 'tropical-island' )?></a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/internal02.jpg" alt="" class="wp-image-2265"/></a></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-base-background-color has-background" style="padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-primary"}}}}} -->
<h3 class="has-link-color"><a href="#"><?php esc_html_e( 'Travelling', 'tropical-island' )?></a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<figure class="wp-block-image size-full"><a href="#"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/internal03.jpg" alt="" class="wp-image-2263"/></a></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"backgroundColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group has-base-background-color has-background" style="padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-primary"}}}}} -->
<h3 class="has-link-color"><a href="#"><?php esc_html_e( 'Vacation', 'tropical-island' )?></a></h3>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
